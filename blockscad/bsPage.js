...
output += '          <a type="button" class="btn btn-default btn-lg" id="report-issue-btn" style="margin-top:2px; display:none" target="_blank">'+ Blockscad.Msg.REPORT_ISSUE +'</a>\n';
output += '        </div>\n';
...
output += '          <li><a href="#codeEditorPane" data-toggle="pill" id="displayCode">' + Blockscad.Msg.CODE_TAB + '</a></li>\n';
...
output += '        <div class="tab-pane content" id="codeEditorPane">';
output += '          <div id="codeEditorToolbar">';
output += '            <button id="applyCodeBtn" class="btn btn-primary btn-sm">Apply to Blocks</button>';
output += '            <span id="codeEditorStatus"></span>';
output += '          </div>';
output += '          <div id="codeEditorDiv"></div>';
output += '          <textarea id="codeEditorFallback" style="display:none; width:100%; height:100%; resize:none; font-family:monospace; font-size:13px; padding:8px; border:none; outline:none;"></textarea>';
output += '        </div>';
